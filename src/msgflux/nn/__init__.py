...
from msgflux.nn.events import EventBus as EventBus  # deprecated, use EventStream
...
from msgflux.nn.events import ModuleEvent as ModuleEvent  # deprecated, use StreamEvent

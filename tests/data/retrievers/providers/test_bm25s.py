...
class TestBM25SLexicalRetriever:
    ...
    @pytest.mark.skip(
        reason="Mock reimports cause numpy.fft._pocketfft_umath 'module loaded twice' error when running full test suite"
    )

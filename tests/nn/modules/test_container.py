...
class TestSequential:
    ...
    def test_sequential_basic(self):
        ...
        seq = Sequential(SimpleModule("A"), SimpleModule("B"), SimpleModule("C"))
    ...
    def test_sequential_insert(self):
        ...
        seq = Sequential(SimpleModule("A"), SimpleModule("C"))
...
class TestModuleList:
    ...
    def test_modulelist_insert(self):
        ...
        mlist = ModuleList([SimpleModule("A"), SimpleModule("C")])
...
class TestModuleDict:
    ...
    def test_moduledict_basic(self):
        ...
        mdict = ModuleDict({"first": SimpleModule("A"), "second": SimpleModule("B")})

...
class TestReActToolFlowControl:
    ...
    def test_tool_call_has_id_and_result_fields(self):
        ...
        # ID is None by default, generated by extract_flow_result
        assert tool_call.id is None
        assert tool_call.result is None

        # With explicit id and result
        tool_call_with_result = ToolCall(
            name="search", arguments={"q": "test"}, id="abc12345", result="found"
        )
        assert tool_call_with_result.id == "abc12345"
